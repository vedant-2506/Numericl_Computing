...
#include "../Include/PlotHelper.hpp"         // Plot helper
#include "../Include/Solutionprinter.hpp"    // Solution printer
#include <vector>                            // Vector storage
#include <cmath>                             // Math library
#include <stdexcept>                         // Exceptions
using namespace std;

GaussianElimination::GaussianElimination() : LinearOperation() {}  // Default constructor
GaussianElimination::GaussianElimination(int r, int c) : LinearOperation(r,c){}  // With dimensions

ostream& operator<<(ostream &out, const GaussianElimination &ge)  // Output operator
